...
const SliderInputSec = ({sendData ,setMood}) => {
        ...
        <div className="  backdrop-blur-lg bg-white/10 rounded-2xl text-2xl text-white font-mono font-bold p-5 flex flex-col gap-10">
          ...
          <div className="flex flex-col">
            ...
            type="text"
              ...
              className="backdrop-blur-lg bg-white/10 rounded-2xl  text-sm p-2  focus:outline-none focus:ring-3 focus:ring-cyan-500"
